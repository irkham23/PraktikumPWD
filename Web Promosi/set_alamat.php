...
if (isset($_POST['btn_tambah'])) {
    ...
    if (count($message)==0) {
    	$insert_sql = "UPDATE pembeli SET alamat = '$Alamat' WHERE id_pembeli = '$id_pembeli'";
    	$insert_qry = $mysqli->query($insert_sql) or die ($mysqli->error);

    	echo "<script>alert('Data Berhasil Ditambah'); window.location = 'alamat.php'</script>";
    }
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<form action="" method="post" enctype="multipart/form-data">
						<h5>Contoh : Padukuhan RT00/RW00, Desa, Kecamatan, Kabupaten, Provinsi kodepos (Patokan)</h5>
						<div class="form-floating">
							<textarea class="form-control" placeholder="Leave a comment here" name="Alamat" id="floatingTextarea2" style="height:100px; width: 100%;"></textarea>
						</div>
						<br><button class="btn btn-primary" type="submit" name="btn_tambah" style="float: right;">Simpan</button>
					</form>
				</div>
				<div class="col-sm-2"></div>
			</div>	
